        ...
        if (window.DTLSfuncBroadcast && window.DTLSfuncBroadcast.args) {
          ...
          if (argKey in window.DTLSfuncBroadcast.args) {
            if (args.TYPE === "(Stringify)") {
              const result2 = window.DTLSfuncBroadcast.args[argKey];
              if (typeof result2 === "object" && result2 !== null) {
                return JSON.stringify(result2);
              }
              if (typeof result2 === "string" && isJSON(result2)) {
                return result2;
              }
              return result2;
            } else {
